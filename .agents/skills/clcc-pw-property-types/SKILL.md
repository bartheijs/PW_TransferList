---
name: clcc-pw-property-types
description: Mendix 10 pluggable-widget property-type reference. Use when adding, changing, or reviewing properties in src/<WidgetName>.xml and their generated TypeScript props, including static, component, dynamic, datasource, action, and selection properties.
---

## Introduction

In order to be configurable, pluggable widgets use a widget properties definition which describes the properties available to pluggable widgets.
...
{{% alert color="info" %}}
This feature was introduced in Mendix 10.24.
{{% /alert %}}
