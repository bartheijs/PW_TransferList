---
name: clcc-pw-propertyTypes
description: A guide for understanding pluggable widgets' property types in Mx10 to be used in widget definition XML file `src/<WidgetName>.xml` for development of Pluggable Widgets voor Mendix.
